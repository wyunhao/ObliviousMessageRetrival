...
void GOMR1() {
    ...
    auto expected = preparingTransactionsFormal(pk, numOfTransactions, num_of_pertinent_msgs_glb, params, party_size_glb);
    ...
    vector<int> steps_next = {0,32,64,128,256,512,1024};
